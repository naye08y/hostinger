...
<a href="carrito.php" class="btn" style="font-family:'Monserrat', sans-serif;">
 ...
 <!----- INVENTARIO --->
  ...
  <div class="px-4 py-3 my-3 text-center">
    <h1 class="titulo">Agregar al inventario</h1><br>
    <img class="d-block mx-auto mb-4" src="img/inventario2.png" alt="" width="110" height="110">
...
<div class="container" >
            <div class="d-flex align-items-center justify-content-between flex-wrap">
             ...
             <form action="php/agregar_inventario.php" method="POST">
              
                   <h5 class="display-7 fw-normal me-2">Nombre:</h5> 
                   <input class="form-control me-2" type="text" placeholder="Ingrese el nombre" style="text-transform:uppercase;" name="nombre" required value> 
              <br>
                   <h5 class="display-7 fw-normal me-2">Cantidad de piezas/rebanadas/cajas/latas/bolsas/botellas/botes/frascos/barras/paquetes</h5> 
                   <input class="form-control me-2" type="text" placeholder="Ingrese un número de piezas" name="piezas" style="text-transform:uppercase;" required value> 
              <br>
                    <center> <button type="submit" class="btn btn-outline-dark">Agregar</button></center><br>
