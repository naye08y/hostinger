...
<header class="p-3 text-white" style="background-color:  #CC6645;"> --->
  ...
  <div class="px-4 py-3 my-3 text-center">
    <h1 class="titulo">Agregar Alimentos al Menú</h1><br>
    ...
    <div class="container-fluid">
        ...
        <ul class=" mx-auto mb-2 mb-lg-0">
          <form action="php/productoA.php" method="POST">
            <h5 class="display-7 fw-normal me-2">Nombre del Alimentos junto al sabor del mismo:</h5>
            <input class="form-control me-2" type="text" placeholder="Nombre del alimento y sabor, Ejemplo: Sandwich jamón con Queso Manchego" name="nombre">
            
            <br>
            <h5 class="display-7 fw-normal me-2">Codigo de la Bebida:</h5>
            <input class="form-control me-2" type="text" placeholder="Código Bebida, Ejemplo: SQMan" name="codigo">
            <br>
            ...
            <center> <button type="submit" class="btn btn-primary">Agregar Alimento al Menú</button></center><br>
