...
<head>
  ...
  <title>Agregar Bebidas Calientes</title>
...
<header class="p-3 text-white" style="background-color:  #CC6645;"> --->
  ...
  <div class="px-4 py-3 my-3 text-center">
    <h1 class="titulo">Agregar Bebidas Calientes al Menú</h1><br>
    <img class="d-block mx-auto mb-4" src="img/chocolate-caliente.png" alt="" width="110" height="110">
    <div class="container-fluid">
            <div class="d-flex align-items-center justify-content-between flex-wrap">
        <ul class=" mx-auto mb-2 mb-lg-0">
          <form action="php/productoBC.php" method="POST">
            <h5 class="display-7 fw-normal me-2">Nombre de la Bebida junto al sabor del mismo:</h5>
            <input class="form-control me-2" type="text" placeholder="Nombre de bebida y sabor, Ejemplo: Latte de Cajeta" name="nombre">
            <br>

            <h5 class="display-7 fw-normal me-2">Codigo de la Bebida:</h5>
            <input class="form-control me-2" type="text" placeholder="Código Bebida, Ejemplo: BebLatteCajeta" name="codigo">
            <br>
            ...
            <table class="table">
              <tr>
                <th style="color:#8d4925;">
                  <rigth>Chico =
                </th>
                </rigth>
                <td> <input class="form-control me-2" type="text" placeholder="Ingrese precio" name="precioch"> </td>
                <th style="color:#8d4925;">
                  <center> Mediano =
                </th>
                </center>
                <td><input class="form-control me-2" type="text" placeholder="Ingrese precio" name="preciom"></td>
                <th style="color:#8d4925;">
                  <center> Grande =
                </th>
                </center>
                <td><input class="form-control me-2" type="text" placeholder="Ingrese precio " name="preciog"></td>
              </tr>
            </table>
