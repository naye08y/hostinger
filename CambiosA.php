<?php
$dir = opendir('img/productos/Alimentos/');
while($f = readdir($dir))
?>
...
$listar = null;
$directorio=opendir("img/productos/Alimentos/");

while ($elemento = readdir($directorio))
{
  if ($elemento != '.' && $elemento != '..')
  {
  if (is_dir("img/productos/Alimentos/".$elemento))
  {
    $listar .="<a class=' col-md-6' href='img/productos/Alimentos/$elemento'target='_blank'> 
    $elemento/</a>
    <br><br>";
  }
  else
...
$folder = "img/productos/Alimentos/";
move_uploaded_file($_FILES["formato"]["tmp_name"] , "$folder".$_FILES["formato"]["name"]);
echo "<div class='alert alert-success'><p class='hidd' align=center>El archivo  ".$_FILES["formato"]["name"]." se ha cargado correctamente. <a href='CambiosA.php' class='btn btn-default'>Clic aquí </a> para verificar.</div>";
  }
...
@unlink('img/productos/Alimentos/'.$borrarFor);
echo "<div class='alert alert-danger'><p class='hidd' align=center>El archivo  ".$borrarFor." ha sido eliminado correctamente. <a href='CambiosA.php' class='btn btn-default'>Clic aquí </a> para verificar.</div>";
}
?>
...
<button type="button" class="btn" onclick="search_producto()">Buscar</button>
 ...
 <!----- INVENTARIO --->
  ...
  <div class="px-4 py-3 my-3 text-center">
    <h1 class="titulo">Cambios Alimentos</h1><br>
    <img class="d-block mx-auto mb-4" src="img/comida-chatarra.png" alt="" width="110" height="110">
...
<div class="container" >
            <div class="d-flex align-items-center justify-content-between flex-wrap">
             ...
             <form action="php/cambios_productosA.php" method="POST">
              ...
              <h5 class="display-7 fw-normal me-2">Precios:</h5> 
                ...
                <table class="table" >
                <tr>
                <th style="color:#8d4925;"> <rigth>Precio =</th> </rigth>
