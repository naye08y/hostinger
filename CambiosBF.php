...
echo "<div class='alert alert-success'><p class='hidd' align=center>El archivo  ".$_FILES["formato"]["name"]." se ha cargado correctamente. <a href='CambiosBF.php' class='btn btn-default'>Clic aquí </a> para verificar.</div>";
  }
...
echo "<div class='alert alert-danger'><p class='hidd' align=center>El archivo  ".$borrarFor." ha sido eliminado correctamente. <a href='CambiosBF.php' class='btn btn-default'>Clic aquí </a> para verificar.</div>";
}
?>
...
<head>
  ...
  <title>Cambios Bebidas Heladas</title>
...
<button type="button" class="btn" onclick="search_producto()">Buscar</button>
 ...
 <!----- INVENTARIO --->
  ...
  <div class="px-4 py-3 my-3 text-center">
    <h1 class="titulo">Cambios Bebidas Heladas</h1><br>
    <img class="d-block mx-auto mb-4" src="img/soda-con-helado.png" alt="" width="110" height="110">
...
<div class="container" >
            <div class="d-flex align-items-center justify-content-between flex-wrap">
             ...
             <form action="php/cambios_productosBF.php" method="POST">
