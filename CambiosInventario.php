...
<head>
  ...
  <title>Cambios en el inventario</title>
...
<header class="p-3 text-white" style="background-color:  #CC6645;"> --->
  ...
  <div class="px-4 py-3 my-3 text-center">
    <h1 class="titulo">Cambios en el inventario</h1><br>
    ...
    <div class="container-fluid">
        ...
        <ul class=" mx-auto mb-2 mb-lg-0">
          ...
          <form action="php/cambios_inventario.php" method="POST">
            ...
            $query1 = ("Select * from inventario where id='$idregistromodificar'");
            ...
            ?>
                ...
                <br>
                <h5 class="display-7 fw-normal me-2">Cantidad de piezas / rebanadas/ shots:</h5>
                <input class="form-control me-2" type="text" value="<?php echo $rowData["piezas"] ?>" name="piezas">
                <br>
