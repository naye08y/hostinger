...
echo "<div class='alert alert-success'><p class='hidd' align=center>El archivo  ".$_FILES["formato"]["name"]." se ha cargado correctamente. <a href='ImagenA.php' class='btn btn-default'>Clic aquí </a> para verificar.</div>";
  }
...
@unlink('iimg/productos/Alimentos/'.$borrarFor);
echo "<div class='alert alert-danger'><p class='hidd' align=center>El archivo  ".$borrarFor." ha sido eliminado correctamente. <a href='ImagenA.php' class='btn btn-default'>Clic aquí </a> para verificar.</div>";
}
?>
...
<button type="button" class="btn" onclick="search_producto()">Buscar</button>
  ...
  <div class="px-4 py-3 my-3 text-center">
    <h1 class="titulo">Imagenes de Alimentos</h1><br>
    <img class="d-block mx-auto mb-4" src="img/comida-rapida.png" alt="" width="110" height="110">
    <center> 
<a href="AgregarProductosA.php"> 
    <button class="btn btn-primary">Agregar nuevo Alimento</button>
</a>
</center>
<br>
 <!----- SUBIR FOTOS --->
