...
echo "<div class='alert alert-success'><p class='hidd' align=center>El archivo  ".$_FILES["formato"]["name"]." se ha cargado correctamente. <a href='ImagenBC.php' class='btn btn-default'>Clic aquí </a> para verificar.</div>";
  }
...
echo "<div class='alert alert-danger'><p class='hidd' align=center>El archivo  ".$borrarFor." ha sido eliminado correctamente. <a href='ImagenBC.php' class='btn btn-default'>Clic aquí </a> para verificar.</div>";
}
?>
...
<head>
  ...
  <title>Imagen Bebidas Calientes</title>
...
<button type="button" class="btn" onclick="search_producto()">Buscar</button>
  ...
  <div class="px-4 py-3 my-3 text-center">
    ...
    <center> 
<a href="AgregarProductosBC.php"> 
    <button class="btn btn-primary">Agregar nueva Bebida Caliente</button>
</a>
</center>
<br>
 <!----- SUBIR FOTOS --->
