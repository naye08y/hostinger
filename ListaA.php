...
<head>
  ...
  <title>Lista Menu Alimentos</title>
...
<header class="p-3 text-white" style="background-color:  #CC6645;"> --->
    ...
    <div class="px-4 py-3 my-3 text-center">
      <h1 class="titulo">Lista de Alimentos</h1><br>
      <a href="AgregarInventario.php">
        <img class="d-block mx-auto mb-4" src="img/comida-chatarra.png" alt="" width="110" height="110" title="Agregar al inventario">
      </a>
      <!-- BUSCAR -->
          ...
          <ul class=" mx-auto mb-2 mb-lg-0">
            ...
            <div>
              <form ction="buscar.php" method="POST" class="d-flex" role="search">
                <h3 class="display-7 fw-normal me-2">Nombre del Alimento:</h3>
        ...
        <div class="D1">
          ...
          <div class="table-responsive">
            ...
            <table class="tablaproductos">
              ...
              $sql = "SELECT id,codigo,nombre,existencia,ruta_img,precio1 FROM productos where categoria_id=3 AND nombre like '$buscar' '%' ";
                ...
                <tr>
                  ...
                  <td class="tablaproductos2">
                    <!--a que archivo quiero que se vaya para modificar los datos y el id de la tabla en la que estamos 
                              trabajando-->
                    <center> <a href="CambiosA.php?id=<?php echo $mostrar['0']; ?>">
