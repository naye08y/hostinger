...
<head>
  ...
  <title>Lista Menu Bebidas Calientes</title>
...
<header class="p-3 text-white" style="background-color:  #CC6645;"> --->
    ...
    <div class="px-4 py-3 my-3 text-center">
      <h1 class="titulo">Lista Bebidas Calientes</h1><br>

      <img class="d-block mx-auto mb-4" src="img/chocolate-caliente2.png" alt="" width="110" height="110" title="Agregar al inventario">
          ...
          <ul class=" mx-auto mb-2 mb-lg-0">
            ...
            <div>
              <form ction="buscar.php" method="POST" class="d-flex" role="search">
                <h3 class="display-7 fw-normal me-2">Nombre de la Bebida:</h3>
          ...
          <div class="table-responsive">
            ...
            <table class="tablaproductos">
              ...
              <th class="tablaproductos2">
                ...
                <th class="tablaproductos2">
                  <center>Ruta de Imagen</center>
                </th>
                <th class="tablaproductos2">
                  <center>Precio Chico</center>
                </th>
                <th class="tablaproductos2">
                  <center>Precio Mediano</center>
                </th>
                <th class="tablaproductos2">
                  <center>Precio Grande</center>
                </th>
                <th class="tablaproductos2">
              ...
              $sql = "SELECT id,codigo, nombre, existencia, ruta_img,precio1,precio2,precio3 FROM productos where categoria_id=1 AND nombre like '$buscar' '%' ";
                ...
                <tr>
                  ...
                  <td class="tablaproductos2">
                    <!--a que archivo quiero que se vaya para modificar los datos y el id de la tabla en la que estamos 
                              trabajando-->
                    <center> <a href="CambiosBC.php?id=<?php echo $mostrar['0']; ?>">
