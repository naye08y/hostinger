...
<head>
  ...
  <title>Lista Menu Bebidas Heladas</title>
...
<header class="p-3 text-white" style="background-color:  #CC6645;"> --->
    ...
    <div class="px-4 py-3 my-3 text-center">
      <h1 class="titulo">Lista Bebidas Heladas</h1><br>
      <a href="AgregarInventario.php">
        <img class="d-block mx-auto mb-4" src="img/soda-con-helado.png" alt="" width="110" height="110" title="Agregar al inventario">
      </a>
      <!-- BUSCAR -->
                ...
                <tr>
                  ...
                  <td class="tablaproductos2">
                    <!--a que archivo quiero que se vaya para modificar los datos y el id de la tabla en la que estamos 
                              trabajando-->
                    <center> <a href="CambiosBF.php?id=<?php echo $mostrar['0']; ?>">
