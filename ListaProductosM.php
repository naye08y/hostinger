...
<style>
  ...
  .botonU {
    ...
    background-image: url("img/chocolate-caliente2.png");
  ...
  .botonH {
    background: transparent;
    background-image: url("img/soda-con-helado.png");
    border-color: transparent;
    background-size: cover;
    background-position: center;
    display: inline-block;
  ...
  .botonP {
    background: transparent;
    background-image: url("img/comida-chatarra.png");
    border-color: transparent;
    background-size: cover;
    background-position: center;
    display: inline-block;
...
<header class="p-3 text-white" style="background-color:  #CC6645;"> --->
  ...
  <div class="px-4 py-3 my-3 text-center">
    <h1 class="titulo">Productos del Menú Gabcy</h1><br>
  </div>
  <div class="px-4 pt-5 my-5 text-center border-bottom">
    <a href="ListaBC.php" title="Bebidas Calientes">
      <div class="botonU"> </div>
    </a>
    <a href="ListaBF.php" title="Bebidas Frías">
      <div class="botonH"> </div>
    </a>
    <a href="ListaA.php" title="Alimentos">
