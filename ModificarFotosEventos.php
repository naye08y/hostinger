...
$listar = null;
$directorio = opendir("img/eventos/");

while ($elemento = readdir($directorio)) {
  if ($elemento != '.' && $elemento != '..') {
    if (is_dir("img/eventos/" . $elemento)) {
      $listar .= "<a class=' col-md-6' href='img/eventos/$elemento'target='_blank'> 
    $elemento/</a>
    <br><br>";
    } else {
      $listar .= "<a class=' col-md-6' href='img/eventos/$elemento'target='_blank'> 
...
if (isset($_POST["subir"])) {
  ...
  if ($subir  == "Cargar archivo") {
    ...
    echo "<div class='alert alert-success'><p class='hidd' align=center>El archivo  " . $_FILES["formato"]["name"] . " se ha cargado correctamente. <a href='ModificarFotosEventos.php' class='btn btn-default'>Clic aquí </a> para verificar.</div>";
  }
}
...
if (isset($_POST['borrarFor'])) {
  ...
  @unlink('img/eventos/' . $borrarFor);
  echo "<div class='alert alert-danger'><p class='hidd' align=center>El archivo  " . $borrarFor . " ha sido eliminado correctamente. <a href='ModificarFotosEventos.php' class='btn btn-default'>Clic aquí </a> para verificar.</div>";
}
?>
...
<head>
  ...
  <title>Modificar fotos de eventos</title>
...
<header class="p-3 text-white" style="background-color:  #CC6645;"> --->
  ...
  <div class="px-4 py-3 my-3 text-center">
    <h1 class="titulo">Fotos de eventos</h1><br>
    <img class="d-block mx-auto mb-4" src="img/eventos.png" alt="" width="110" height="110">
    ...
    <center>
      <div class="alert alert-light" role="alert">
        ...
        <p>Las fotos que se suban seran eliminadas dentro de 1 año.</p>
