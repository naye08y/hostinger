...
<div class="px-4 py-3 my-3 text-center">
  ...
  <p>Aqui solo se registraran ventas de productos grandes.</p>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td class="tablaventas2"><?php echo $producto->precio3 ?></td>
                    ...
                    <td class="tablaventas2"><a class="btn btn-danger" href="<?php echo "quitarDelCarrito.php?indice=" . $indice ?>"><i class="fa fa-trash"></i></a></td>
                </tr>
            <?php } ?>
        </tbody>
    </table>
