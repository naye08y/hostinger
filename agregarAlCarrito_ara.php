...
if (!$producto) {
    header("Location: ./registro_ventas_ara.php?status=4");
    exit;
}
# Si no hay existencia...
if ($producto->existencia < 1) {
    header("Location: ./registro_ventas_ara.php?status=5");
    exit;
}
session_start();
