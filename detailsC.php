            ...
            <div class="card mb-3 text-center" style="border-color: white;">
                <div class="row g-0">
                    <div class="col-md-7">
                        ...
                        <h5 style="color:#000000ff;  font-family: 'Playfair Display';  ">Tamaños:</p>
                            <select id="mySelect" class="form-select-sm " aria-label=".form-select-sm" style="border: 0.05em solid #000000ff; border-radius: 1em; background: white;">
                            ...
                            <h5 style="color:#000000ff;  font-family: 'Playfair Display';  ">Precio:</p>
                                <input style="border: 0.05em solid #000000ff; border-radius: 1em; " class="form-select-sm " type="text" id="myInput" readonly>MXN
                               <br>
                               <br>
