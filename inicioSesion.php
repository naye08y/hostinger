...
<header class="p-3 text-white" style="background-color:  #CC6645;"> --->
  ...
  <!--Inicio de Sesión -->
  <div class="overlay">
    <form class="form2" action="php/login.php" method="POST">
      ...
      if (isset($_GET['e'])) {
        switch ($_GET['e']) {
          ...
          case '3':
            echo '<div class="alert alert-danger" role="alert">
                              Contraseña Incorrecta, Verifica e intenta devueno
                            </div>';
            break;
          default:
            break;
      ...
      <div class="con">
        ...
        <div class="field-set">
          ...
          <br>
          <button class=" button2 log-in"> Iniciar Sesión </button>
        </div>
        <div class="other">
          <button class="button2 submits2 frgt-pass" onClick="redirect2()">Olvide mi Contraseña</button>
...
<script type="text/javascript">
  function redirect2() {
    ...
    window.location.href = "olvido.php";
  }
</script>
