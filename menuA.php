      ...
      <div class="container">
        <div class="row g-5">
          <div class="col-md-2">
            ...
            <br><br>
            <h4 style="color: #000000ff; font-family: 'Playfair Display', serif;"> Alimentos</h4>
...
<script type="text/javascript"> 
  ...
  '<br><br>'+
    '<img src="img/productos/Alimentos/'+data.datos[i].ruta_img+'"" class="img-thumbnail"  width="1500" height="6300">'+
  '</article>'+
