...
<!--Menu de registro / empleado Gabcy -->
...
<div class="px-4 py-3 my-3 text-center">
      <h1 class="titulo">Tamaños</h1><br>
      <img class="d-block mx-auto mb-4" src="img/charola.png" alt="" width="110" height="110">
          <h2>Por favor seleccione el tamaño del producto a vender.</h2><br>
      <div class="container-fluid">
    ...
    <div class="col align-self-start">
       <img class="d-block mx-auto mb-4" src="img/bolsa.png" alt="" width="70" height="70">
       <a class="btn btn-success" href="./Registro_ventasC.php">Chico o Normal</a>
    </div>
    <div class="col align-self-center">
     <img class="d-block mx-auto mb-4" src="img/bolsa.png" alt="" width="85" height="85">
       <a class="btn btn-success" href="./Registro_ventasM.php">Mediano</a>
    </div>
    <div class="col align-self-end">
    <img class="d-block mx-auto mb-4" src="img/bolsa.png" alt="" width="110" height="110">
       <a class="btn btn-success" href="./Registro_ventas.php">Grande</a>
    </div>
    </center>
