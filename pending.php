...
<header class="p-3 text-white" style="background-color:  #CC6645;"> --->
  ...
  <div style="text-align:center; margin-top:50px;">
    ...
    <p>Estamos esperando la confirmación de tu pago. Te notificaremos cuando esté aprobado.</p>
    ...
    <a href="pagoMercadoLibre.php" style="text-decoration:none; color:white; background:#FFA500; padding:10px 20px; border-radius:5px;">Volver al inicio</a>
  </div>
