...
.herbales-section {
  ...
  align-items: center;
  background-image: url('img/banner_nutricionales.jpg');
...
<section class="herbales-section">
  <div class="herbales-card">
    <div class="herbales-content">
      <h2>Nutricionales</h2>
      <p>Suplementos y alimentos que fortalecen tu salud desde adentro.</p>
      <a href="productos_nutricionales.php">Descubre opciones naturales, balanceadas y pensadas para tu bienestar 🥗</a>
    </div>
  </div>
</section>
  ...
  <div class="row">
    ...
    <aside class="col-md-3 mb-4">
      <div class="sidebar p-3">
        ...
        <form method="GET" action="productos_nutricionales.php" id="formFiltro">
          <div class="mb-3">
...
$query = "SELECT id, nombre, ruta_img, precio1 FROM productos WHERE categoria_id = 3";
$params = [];
                  ...
                  <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                      ...
                      <div class="d-flex flex-column gap-2">
                        <a href="detallesNutricionales.php?id=<?php echo $row['id']; ?>&token=<?php echo hash_hmac('sha1', $row['id'], KEY_TOKEN); ?>" class="btn btn">
                          Detalles
                        </a>
...
<script>
  document.getElementById('btnClearFilters').addEventListener('click', function() {
    ...
    window.location.href = 'productos_nutricionales.php';
  });
</script>
