...
$con = $db->conectar();
//session_destroy();
$sql = $con->prepare("SELECT id, nombre, ruta_img, precio1 FROM productos WHERE categoria_id = 1");
$sql->execute();
...
.herbales-section {
  ...
  align-items: center;
  background-image: url('img/banner_nutricosmeticos.jpg');
...
<section class="herbales-section">
  <div class="herbales-card">
    <div class="herbales-content">
      <h2>Nutricosmeticos</h2>
      <p>Suplementos naturales diseñados para nutrir y potenciar tu salud día a día.</p>
      <a href="productos_nutricosmeticos.php">Explora nuestra selección saludable y equilibrada 🧴</a>
    </div>
  </div>
</section>
  ...
  <div class="row">
    ...
    <aside class="col-md-3 mb-4">
      <div class="sidebar p-3">
        ...
        <form method="GET" action="productos_nutricosmeticos.php" id="formFiltro">
          <div class="mb-3">
...
$query = "SELECT id, nombre, ruta_img, precio1 FROM productos WHERE categoria_id = 1";
$params = [];
                   ...
                   <img class="card-img-top" src="img/Productos_Ara/<?php echo $row['ruta_img']; ?>" alt="<?php echo $row['nombre']; ?>">
                    <div class="card-body">
                      ...
                      <div class="d-flex flex-column gap-2">
                        <a href="detallesNutricosmeticos.php?id=<?php echo $row['id']; ?>&token=<?php echo hash_hmac('sha1', $row['id'], KEY_TOKEN); ?>" class="btn btn">
                          Detalles
                        </a>
...
<script>
  document.getElementById('btnClearFilters').addEventListener('click', function() {
    ...
    window.location.href = 'productos_nutricosmeticos.php';
  });
</script>
